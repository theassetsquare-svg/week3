...
const HT_NIGHT = [
  ...
  "역세권 나이트라이프의 정석","20년 터줏대감, 이유가 있다","초보도 편한 밤의 시작",
  ...
  "나이트라이프 입문 최적의 장소","혼자 와도 어색하지 않은 곳","예약 없이 가면 후회하는 곳",
...
const raw = [
  // 룸 (2)
  {name:"일산룸",type:"룸",region:"일산",nickname:"일산룸 총책임자",phone:"010-4117-5556"},
  {name:"해운대고구려",type:"룸",region:"부산해운대",nickname:"",phone:""},
  // 요정 (1)
  {name:"일산명월관요정",type:"요정",region:"일산",nickname:"일산룸 총책임자",phone:"010-4117-5556"},
  // 나이트 서울 (12)
  ...
  {name:"파주야당스카이돔나이트",type:"나이트",region:"파주",nickname:"딸기",phone:"010-3447-0963"},
  ...
  {name:"수원찬스돔나이트",type:"나이트",region:"수원",nickname:"박찬호",phone:"010-7117-5077"},
  ...
  {name:"성남샴푸나이트",type:"나이트",region:"성남",nickname:"이쁜이",phone:"010-3432-4758"},
